...
### Buscar las variables del proyecto y organización
Menú (izquierda) - Project Information - About this project
  - SONAR_ORGANIZATION
  - SONAR_PROJECT_KEY
...
- Trivy: Es un escáner Open Source muy popular para contenedores.
- Es *stateless*: no requiere crear cuenta ni configurar un Token (ideal para flujos CI/CD rápidos).
